...
CREATE TABLE IF NOT EXISTS travel_requests (id TEXT PRIMARY KEY,folio TEXT UNIQUE NOT NULL,status TEXT NOT NULL DEFAULT 'PENDIENTE',user_id TEXT,requester_name TEXT,department TEXT,request_type TEXT,detail TEXT,request_date DATE,deposit_date DATE,urgency TEXT,boss_id TEXT,boss_email TEXT,boss_name TEXT,start_date TIMESTAMPTZ,end_date TIMESTAMPTZ,destination TEXT,reason TEXT,amount_requested NUMERIC,amount_authorized NUMERIC,transport_cost NUMERIC,hotel_cost NUMERIC,food_cost NUMERIC,misc_cost NUMERIC,comments TEXT,approved_by TEXT,approved_at TIMESTAMPTZ,created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),approval_token TEXT,rejected_by TEXT,rejected_at TIMESTAMPTZ,rejection_reason TEXT,updated_at TIMESTAMPTZ);
ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS deposit_date DATE; ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS approval_token TEXT; ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS rejected_by TEXT; ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS rejected_at TIMESTAMPTZ; ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS rejection_reason TEXT; ALTER TABLE travel_requests ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ;
