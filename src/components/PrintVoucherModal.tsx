...
export default function PrintVoucherModal({ request, onClose }: PrintVoucherModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[calc(100vh-2rem)] border border-slate-200 overflow-hidden flex flex-col print:m-0 print:border-none print:shadow-none print:max-h-none print:overflow-visible print:flex-none print:h-auto animate-in fade-in duration-150">
        ...
        <div className="p-8 sm:p-10 space-y-6 text-slate-800 bg-white font-sans overflow-y-auto flex-1 min-h-0 print:overflow-visible print:flex-none print:h-auto">
          {/* Header */}
